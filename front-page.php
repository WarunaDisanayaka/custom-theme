...
<header class="masthead">
  <div class="container h-100">
    <div class="row h-100 align-items-center">
      <div class="col-12 ">
        <h1 class="">SHOPPING AT MARINA BAY</h1>
        <h1 class="">SANDS</h1>
      </div> 
    </div>
  </div>
...
<div class="container mt-4 card-section">
  <div class="row">
<?php 
  $carpost=new WP_Query(array(
    'posts_per_page'=>2,
    'post_type'=>'cars'
  ));

  while ($carpost->have_posts()) {
    $carpost->the_post(  );?>
     <div class="col-md-3">
      <div class="card" style="width: 18rem;">
  <img src="<?php the_post_thumbnail_url()?>">
  <div class="card-body">
    <h5 class="card-title"><?php the_title()?><a href="<?php the_permalink();?>" class="stretched-link"></a></h5>
...
</svg> <?php the_field('open_time')?>-<?php the_field('close_time')?></p>
